...
export default async function Home() {
  ...
  return (
    <>
      <div className="border border-black row-start-1 row-end-7 col-start-1 col-end-2 flex-col items-center pt-8 pb-16 px-4 gap-4 lg:flex hidden">
      ...
      <div className="border border-black row-start-1 row-end-7 col-start-4 col-end-5 flex-col items-center pt-8 pb-16 px-4 gap-4 lg:flex hidden">
