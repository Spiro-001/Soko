  ...
  return (
    <div className="flex flex-col gap-y-8">
      <div className="flex flex-col mb-4">
        <span className="font-semibold py-2 text-sm px-4 mb-4 z-20 rounded-md border border-blue-200 shadow-sm">
          Bio
        </span>
        <div className="px-4 py-3 bg-neutral-50 rounded-md border border-neutral-100">
          <Bio
            bio={
